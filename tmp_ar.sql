INSERT INTO blog_posts (id, slug, title, excerpt, content, author_id, status, lang, parent_id, created_at, updated_at) VALUES ('4a659d2d-5c1d-4988-bd1f-424bd27b43a2', 'daily-5-minute-english-speaking-habit-ar', 'كيفية بناء عادة التحدث باللغة الإنجليزية لمدة 5 دقائق يوميًا', 'قم ببناء عادة التحدث باللغة الإنجليزية يوميًا في 5 دقائق فقط. تعلم طرق بسيطة للممارسة بانتظام، وتحدث بثقة واجعل اللغة الإنجليزية جزءًا من حياتك اليومية.', '<p>You want to speak English better, but studying for an hour every day isn''t always realistic. Work, school, and everyday life can easily get in the way.</p>
...
<p><strong>Connect. Speak. Earn.</strong></p>', 'system', 'published', 'ar', 'c23b4743-7dc0-4f40-8bfc-a71068f8b7b1', '2026-08-16 05:16:45', '2026-08-16 05:16:45');