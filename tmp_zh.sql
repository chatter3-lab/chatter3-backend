INSERT INTO blog_posts (id, slug, title, excerpt, content, author_id, status, lang, parent_id, created_at, updated_at) VALUES ('03c8e8ee-d8f9-41a9-aa90-38dcdeb13fa1', 'daily-5-minute-english-speaking-habit-zh', '如何养成每天 5 分钟说英语的习惯', '只需 5 分钟即可养成日常英语口语的习惯。学习简单的方法来持续练习、自信地说话并使英语成为您日常生活的一部分。', '<p>You want to speak English better, but studying for an hour every day isn''t always realistic. Work, school, and everyday life can easily get in the way.</p>
...
<p><strong>Connect. Speak. Earn.</strong></p>', 'system', 'published', 'zh', 'c23b4743-7dc0-4f40-8bfc-a71068f8b7b1', '2026-08-16 05:16:45', '2026-08-16 05:16:45');