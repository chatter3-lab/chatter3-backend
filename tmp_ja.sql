INSERT INTO blog_posts (id, slug, title, excerpt, content, author_id, status, lang, parent_id, created_at, updated_at) VALUES ('3b5f8fe6-3d50-423f-b86f-9434aedc281c', 'daily-5-minute-english-speaking-habit-ja', '毎日5分間英語を話す習慣を築く方法', 'わずか5分で毎日英語を話す習慣を身につけましょう。継続的に練習する簡単な方法を学び、自信を持って話し、英語を日常生活の一部にしましょう。', '<p>You want to speak English better, but studying for an hour every day isn''t always realistic. Work, school, and everyday life can easily get in the way.</p>
...
<p><strong>Connect. Speak. Earn.</strong></p>', 'system', 'published', 'ja', 'c23b4743-7dc0-4f40-8bfc-a71068f8b7b1', '2026-08-16 05:16:45', '2026-08-16 05:16:45');